...
class GoogleBooksController extends AbstractController
{
    ...
    /**
     * Add a new Book from Google Books API search
     *
     * @param string $word
     * @param CallApiService $callApiService
     ...
     * @return Response
     */
    #[Route('/googleBooksAdd/{word}', name: 'googleBooksAdd')]
    public function googleBooksAdd(string $word, CallApiService $callApiService, AuthorRepository $authorRepository, Request $request, EntityManagerInterface $entityManager): Response
    {
        $book = new Book();
